...
awk 'BEGIN{FS=",";OFS=","} {if ($12 > 5) print $3,$5,$9,$11,$12}' ./data/wq-red.csv > ./data/red_wine_good.csv 
awk 'BEGIN{FS=",";OFS=","} {if ($12 < 5) print $3,$5,$9,$11,$12}' ./data/wq-red.csv > ./data/red_wine_poor.csv
awk 'BEGIN{FS=",";OFS=","} {if ($12 > 5) print $3,$5,$9,$11,$12}' ./data/wq-white.csv > ./data/white_wine_good.csv
awk 'BEGIN{FS=",";OFS=","} {if ($12 < 5) print $3,$5,$9,$11,$12}' ./data/wq-white.csv > ./data/white_wine_poor.csv
