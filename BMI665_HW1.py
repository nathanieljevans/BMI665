...
'''
# this needs to be put in a separate text file I assume ? 
...
def FlowControl(): 
    ...
    '''
    l = input("How many times shall we roll the dice?")
    assert type(l) == "int" & l > 0 , "please enter and integer greater than 0" 
    r = []
    for i in range(l):
